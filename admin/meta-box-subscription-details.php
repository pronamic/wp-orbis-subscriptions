...
<table class="form-table">
	<tr valign="top">
		<th scope="row">
			<label for="orbis_subscription_company"><?php _e( 'Company ID', 'orbis' ); ?></label>
		</th>
		<td>
	...
	<tr valign="top">
		<th scope="row">
			<label for="orbis_subscription_type"><?php _e( 'Type', 'orbis' ) ?></label>
		</th>
		<td>
	...
	<?php if ( false ) : ?>
		...
		<tr valign="top">
			<th scope="row">
				<label for="orbis_subscription_activation_date"><?php _e( 'Activation Date', 'orbis' ) ?></label>
			</th>
			<td>
		...
		<tr valign="top">
			<th scope="row">
				<label for="orbis_subscription_expiration_date"><?php _e( 'Expiration Date', 'orbis' ) ?></label>
			</th>
			<td>
